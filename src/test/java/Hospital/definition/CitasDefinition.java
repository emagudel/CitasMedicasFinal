...
public class CitasDefinition {
	...
	public void ingreso_a_la_funcionalidad_de_agendar_citas_del_hospital() throws Throwable {
		stepCitas.ingresoPortalCitas();
	}


	@When("^Diligencio el formulario de agendamiento de citas medicas$")
	public void diligencio_el_formulario_de_agendamiento_de_citas_medicas(List<CargarDatos> listData) throws Throwable {
	...
	public void verifico_que_las_citas_se_agendaron_exitosamente() throws Throwable {
		stepCitas.VerificarCitasExitosas();
	}
	
	@Then("^Verifico que las citas se agendaron con errores$")
	public void Verifico_que_las_citas_se_agendaron_con_errores() throws Throwable {
